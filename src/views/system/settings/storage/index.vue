      ...
      <div v-show="showSearch" class="search">
        <el-form ref="queryFormRef" :inline="true" :model="queryParams">
          <el-form-item label="配置key" prop="configKey">
            <el-input v-model="queryParams.configKey" clearable placeholder="配置key" @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item label="桶名称" prop="bucketName">
            <el-input v-model="queryParams.bucketName" clearable placeholder="请输入桶名称" @keyup.enter="handleQuery" />
          </el-form-item>
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermi="['system:ossConfig:add']" icon="Plus" plain type="primary" @click="handleAdd">新增 </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['system:ossConfig:edit']" :disabled="single" icon="Edit" plain type="success" @click="handleUpdate()"
              >修改
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['system:ossConfig:remove']" :disabled="multiple" icon="Delete" plain type="danger" @click="handleDelete()">
              删除
            </el-button>
          </el-col>
      ...
      <el-table v-loading="loading" :data="ossConfigList" border @selection-change="handleSelectionChange">
        <el-table-column align="center" type="selection" width="55" />
        <el-table-column v-if="columns[0].visible" align="center" label="主建" prop="ossConfigId" />
        <el-table-column v-if="columns[1].visible" align="center" label="配置key" prop="configKey" />
        <el-table-column v-if="columns[2].visible" align="center" label="访问站点" prop="endpoint" width="200" />
        <el-table-column v-if="columns[3].visible" align="center" label="自定义域名" prop="domain" width="200" />
        <el-table-column v-if="columns[4].visible" align="center" label="桶名称" prop="bucketName" />
        <el-table-column v-if="columns[5].visible" align="center" label="前缀" prop="prefix" />
        <el-table-column v-if="columns[6].visible" align="center" label="域" prop="region" />
        <el-table-column v-if="columns[7].visible" align="center" label="桶权限类型" prop="accessPolicy">
        ...
        <el-table-column v-if="columns[8].visible" align="center" label="是否默认" prop="status">
          <template #default="scope">
        ...
        <el-table-column align="center" class-name="small-padding" fixed="right" label="操作" width="150">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['system:ossConfig:edit']" icon="Edit" link type="primary" @click="handleUpdate(scope.row)"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermi="['system:ossConfig:remove']" icon="Delete" link type="primary" @click="handleDelete(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
