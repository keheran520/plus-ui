  ...
  <div class="custom-step3">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="VLAN标签">
        <el-input-number v-model="localData.vlanTag" :min="1" :max="4094" placeholder="可选" style="width: 300px" />
        <div class="form-tip">可选，用于VLAN网络隔离（1-4094）</div>
      </el-form-item>
      
      <el-form-item label="速率限制">
        <el-input-number v-model="localData.rateLimit" :min="0" placeholder="可选" style="width: 200px" />
        <span style="margin-left: 8px; color: #909399;">MB/s (0=不限制)</span>
        <div class="form-tip">限制网络带宽，0表示不限制</div>
      </el-form-item>
...
onMounted(() => {
  ...
  if (!localData.value.networkModel) localData.value.networkModel = 'virtio';
});
