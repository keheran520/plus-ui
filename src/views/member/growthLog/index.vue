    ...
    <section class="list-panel">
      <header class="panel-toolbar">
        <div class="toolbar-title">
          <span class="title-text">成长值记录</span>
          <span class="title-meta">{{ total }} 条记录</span>
        </div>
        <div class="toolbar-actions">
          <el-button v-hasPermi="['member:growthLog:export']" icon="Download" plain @click="handleExport">导出</el-button>
        </div>
      </header>

      <el-table v-loading="loading" :data="growthLogList" class="manage-table">
